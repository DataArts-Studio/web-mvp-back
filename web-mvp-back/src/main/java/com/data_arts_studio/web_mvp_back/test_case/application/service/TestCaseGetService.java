...
public class TestCaseGetService implements GetTestCaseUseCase {
    ...
    // 특정 테스트 케이스 상세 조회
    @Override
    public GetTestCaseDetailResult getTestCaseDetails(String projectId, String testCaseId) {
        ...
        return GetTestCaseDetailResult.builder()
    ...
    @Override
    public List<GetTestCaseListItemResult> getProjectTestCases(String projectId) {
        return loadTestCasePort.loadByProjectId(projectId).stream()
                .map((TestCase testCase) -> new GetTestCaseListItemResult(
