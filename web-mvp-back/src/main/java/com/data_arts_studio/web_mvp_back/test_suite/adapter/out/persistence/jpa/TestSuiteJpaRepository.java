...
public interface TestSuiteJpaRepository extends JpaRepository<TestSuiteJpaEntity, String> {
     ...
     */
    Optional<TestSuiteJpaEntity> findByIdAndProjectId(String id, String projectId);
     ...
     */
    List<TestSuiteJpaEntity> findAllByProjectIdOrderBySortOrderAsc(String projectId);
}
